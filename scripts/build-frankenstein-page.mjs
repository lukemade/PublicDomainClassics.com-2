...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Rubik+Wet+Paint&family=IM+Fell+English:ital@0;1&family=IM+Fell+English+SC&family=IM+Fell+French+Canon:ital@0;1&family=IM+Fell+DW+Pica+SC&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="/src/css/document-template.css">
  <style>
    /* Page-specific: hero cover image, parallax bg */
    .hero {
      min-height: min(calc(100vh - 44px), 800px);
      clip-path: inset(0);
    }
    .hero-bg-image {
      position: fixed;
  ...
  <header class="hero">
    ...
    <div class="hero-inner">
      <div class="hero-content">
        ...
        <div class="hero-meta">
          <span><strong>Author</strong>Mary Shelley (1797&ndash;1851)</span>
          <span><strong>First Published</strong>1 January 1818</span>
          <span><strong>Genre</strong>Gothic Fiction / Science Fiction</span>
          <span><strong>Structure</strong>4 Letters + 24 Chapters</span>
          <span><strong>Source</strong>Project Gutenberg (#84)</span>
        </div>
      </div>
