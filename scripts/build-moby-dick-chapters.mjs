  ...
  <nav class="site-nav" aria-label="Site navigation">
    <div class="site-nav-inner">
      ...
      <button class="book-switch" id="library-open" aria-label="Switch book">
        ...
        <span class="book-switch-title">Moby-Dick</span>
...
const libraryBooks = [
  { title: 'Moby-Dick; or, The Whale', author: 'Herman Melville', year: 1851, genre: 'Adventure', desc: 'Captain Ahab\\u2019s obsessive quest for the great white whale\\u2014a towering work of American literature.', url: '/books/moby-dick/', cover: '/books/moby-dick/images/default.jpg', current: true },
  { title: 'Frankenstein; or, The Modern Prometheus', author: 'Mary Shelley', year: 1818, genre: 'Gothic Fiction', desc: 'A tale of ambition, creation, and consequence\\u2014widely considered the first science fiction novel.', url: '/books/frankenstein/', cover: '/books/frankenstein/images/default.jpg' },
...
function bookHeader(chapter, chapterIdx, isCover) {
  ...
  if (isCover) {
    ...
    const chapterMatch = chapter.title.match(/^(Chapter\s+\d+)\.\s*(.+)/i);
    let eyebrow, chapterName;
    if (chapterMatch) {
      eyebrow = chapterMatch[1];
      chapterName = chapterMatch[2];
    } else {
      // For non-chapter sections (Etymology, Extracts, Epilogue)
      eyebrow = '';
      chapterName = chapter.title;
    }
    const eyebrowHtml = eyebrow ? '<div class="chapter-eyebrow">' + eyebrow + '</div>' : '';
    innerContent = `
      <div class="book-header-cover-wrap">
        <img class="book-header-cover" src="/books/moby-dick/images/default.jpg" alt="" loading="eager">
      </div>
      <div class="book-header-text-wrap">
        ${eyebrowHtml}
